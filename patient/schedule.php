     ...
     <table class="menu-container" border="0">
             ...
             <tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Available Appointment</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body">
            ...
            ?>
                                        ...
                                        <input type="Submit" value="Available Appointments" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                                        </form>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No available Appointment</p>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h4-search">
                                                                '.$scheduledate.'<br>Time: <b>'.substr($scheduletime,0,5).'</b> 
                                                            </div>
                                                            <br>
