            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">New Patient Bookings</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <p style="font-size: 23px;padding-left:12px;font-weight: 600;margin-left:20px;">RECETIONIST</p>
